...
<table style="text-align:center">
    ...
    <tr>
    <td rowspan="6">
    <p>创建型模式<br />Creational Pattern</p>
    </td>
    <td><p>单例模式<br />Singleton Pattern</p></td>
    <td>★☆☆☆☆</td>
    <td>★★★★☆</td>
    </tr>
    
    <tr>
    <td><p>简单工厂模式<br />Simple Factory Pattern</p></td>
    <td>★★☆☆☆</td>
    <td>★★★☆☆</td>
    </tr>
    
    <tr>
    <td><p>工厂方法模式<br />Factory Method Pattern</p></td>
    <td>★★☆☆☆</td>
    <td>★★★★★</td>
    </tr>
    
    <tr>
    <td><p>抽象工厂模式<br />Abstract Factory Pattern</p></td>
    <td>★★★★☆</td>
    <td>★★★★★</td>
    </tr>
    
    <tr>
    <td><p>原型模式<br />Prototype Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★☆☆</td>
    </tr>
    
    <tr>
    <td><p>建造者模式<br />Builder Pattern</p></td>
    <td>★★★★☆</td>
    <td>★★☆☆☆</td>
    </tr>
    ...
    <tr>
    <td rowspan="7">
    <p>结构型模式<br />Structural Pattern</p>
    </td>
    <td><p>适配器模式<br />Adapter Pattern</p></td>
    <td>★★☆☆☆</td>
    <td>★★★★☆</td>
    </tr>
    
    <tr>
    <td><p>桥接模式<br />Bridge Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★☆☆</td>
    </tr>
    
    <tr>
    <td><p>组合模式<br />Composite  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★★☆</td>
    </tr>
    
    <tr>
    <td><p>装饰模式<br />Decorator  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★☆☆</td>
    </tr>
    
    <tr>
    <td><p>外观模式<br />Façade  Pattern</p></td>
    <td>★☆☆☆☆</td>
    <td>★★★★★</td>
    </tr>
    
    <tr>
    <td><p>享元模式<br />Flyweight  Pattern</p></td>
    <td>★★★★☆</td>
    <td>★☆☆☆☆</td>
    </tr>
    
    <tr>
    <td><p>代理模式<br />Proxy  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★★☆</td>
    </tr>
    ...
    <tr>
    <td rowspan="11">
    <p>行为型模式<br />Behavioral Pattern</p>
    </td>
    <td><p>职责链模式<br />Chain  of Responsibility Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★☆☆☆</td>
    </tr>
    
    <tr>
    <td><p>命令模式<br />Command  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★★☆</td>
    </tr>
    
    <tr>
    <td><p>解释器模式<br />Interpreter  Pattern</p></td>
    <td>★★★★★</td>
    <td>★☆☆☆☆</td>
    </tr>
    
    <tr>
    <td><p>迭代器模式<br />Iterator  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★★★</td>
    </tr>
    
    <tr>
    <td><p>中介者模式<br />Mediator  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★☆☆☆</td>
    </tr>
    
    <tr>
    <td><p>备忘录模式<br />Memento  Pattern</p></td>
    <td>★★☆☆☆</td>
    <td>★★☆☆☆</td>
    </tr>
    
    <tr>
    <td><p>观察者模式<br />Observer  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★★★</td>
    </tr>
    
    <tr>
    <td><p>状态模式<br />State  Pattern</p></td>
    <td>★★★☆☆</td>
    <td>★★★☆☆</td>
    </tr>
    
    <tr>
    <td><p>策略模式<br />Strategy  Pattern</p></td>
    <td>★☆☆☆☆</td>
    <td>★★★★☆</td>
    </tr>
    
    <tr>
    <td><p>模板方法模式<br />Template  Method Pattern</p></td>
    <td>★★☆☆☆</td>
    <td>★★★☆☆</td>
    </tr>
    
    <tr>
    <td><p>访问者模式<br />Visitor  Pattern</p></td>
    <td>★★★★☆</td>
    <td>★☆☆☆☆</td>
    </tr>
