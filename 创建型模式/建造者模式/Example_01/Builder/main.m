...
#import "HighPersonBuilder.h"

int main(int argc, const char * argv[]) {
    @autoreleasepool {
        PersonBuilder<PersonBuilder> *personBuilder = [[HighPersonBuilder alloc] init];
        PersonDirector *director = [[PersonDirector alloc] initWithBuilder:personBuilder];
        [director createPerson];
        NSLog(@"%@", [personBuilder getPerson]);
    }
    return 0;
}
