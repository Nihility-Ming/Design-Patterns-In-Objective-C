...
//定义中介者对象
var mediator:ConcreteMediator = ConcreteMediator();

//定义同事对象
var addBT:Button = Button();
var list:List = List();
var cb:ComboBox = ComboBox();
var userNameTB:TextBox = TextBox();

addBT.mediator = mediator;
list.mediator = mediator;
cb.mediator = mediator;
userNameTB.mediator = mediator;
