/**
 解析器模式：给定一个语言，定义它的文法的一种表示，并定义一个解析器，这个解析器使用该表示来解释语言中的句子。
 解释器模式总结
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        [list addObject:[[NonterminalExpression alloc] init]];
        [list addObject:[[TerminalExpression alloc] init]];
        [list addObject:[[TerminalExpression alloc] init]];
        
        [list enumerateObjectsUsingBlock:^(AbstractExpression<AbstractExpression>* exp, NSUInteger idx, BOOL *stop) {
